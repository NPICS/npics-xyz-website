...
export default function SignModal(props: Iprops) {
  ...
  return (agreementSign ? <SignGif
      ...
      <div className='content-agreement'>
        ...
        {signState === 'success' ?
          <div className='success-content'>
            ...
            <ButtonDefault onClick={onMetaMask} types={"four"} minWidth="220px" height="46px" fontSize='16px'>
              Add to MetaMask
            </ButtonDefault>
    ...
    <div className='footer'>
      {signState === 'failure' ?
        <ButtonDefault onClick={onBack} types={"two"} minWidth="200px" height="52px" fontSize='20px'>
          Back
        </ButtonDefault>
        : signState === 'success' ?
          ...
          : <div className='footerBtn'>
            <div>
              <ButtonDefault onClick={onCancel} types={"two"} minWidth="200px" height="52px" fontSize='20px'>Cancel</ButtonDefault>
            </div>
            <div>
              <ButtonDefault onClick={onSign} types={"three"} minWidth="200px" height="52px" fontSize='20px'>Checkout</ButtonDefault>
            </div>
          </div>}
    </div>
  </ModalBody>)
