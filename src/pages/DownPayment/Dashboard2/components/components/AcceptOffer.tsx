          ...
          <Grid gridArea={`price`}>
            ...
            <Flex flexDirection={`column`} alignItems={`stretch`}>
              ...
              >
                ...
                <OfferCell
                  title={`${accpetOffer && OFFER_TYPE_NAME_ENUM[accpetOffer.offerSource]
                    } Market Fee`}
                  popoverInfo={`Fee to ${accpetOffer && OFFER_TYPE_NAME_ENUM[accpetOffer.offerSource]
                    }`}
                  infoIcon={true}
                  symbolIcon={false}
                  symbolOrVal={`${accpetOffer &&
                    thirdPartyFee[accpetOffer.offerSource].marketFee * 100
                    }%`}
                />
                <OfferCell
                  title={`Market Fee`}
                  popoverInfo={`Fee to ${accpetOffer && OFFER_TYPE_NAME_ENUM[OFFER_TYPE_ENUM.npics]
                    }`}
                  infoIcon={true}
                  symbolIcon={false}
                  symbolOrVal={`${accpetOffer &&
