...
interface IProps {
  ...
  reload: boolean;
  activities: VaultsItemData | undefined;
  tradeTx: string;
}
...
export default function PaySuccessful(props: IProps) {
  ...
  const jumpToNFTEtherscan = () => {
    window.open(
      `https://cn.etherscan.com/nft/${activities?.nft}/${activities?.tokenId}`
    );
  };
    ...
    <Flex flexDirection={"column"}>
      ...
      >
        <Typography textAlign="center">
          <Icon width="1.6rem" height="1.6rem" src={imgurl.dashboard.success} />
        </Typography>
      ...
      >
        ...
        >
          <Typography
            ...
            color="#000"
            onClick={async () => {
              activities && (await copyToClipboard(activities?.nft));
              // onClose()
            }}
          >
            Add to Wallet
