...
import ProgressBar from "pages/DownPayment/Dashboard2/components/components/ProgressBar";
                ...
                <Flex alignItems={"center"}>
                  ...
                  >
                    {!activities
                      ? TextPlaceholder
                      : activities.nftName ||
                      `${_toString(activities.collectionName)} #${activities?.tokenId ?? TextPlaceholder
                      }`}
                  </Typography>
                  <Icon
                ...
                <Flex alignItems={"center"} marginBottom={"0.12rem"}>
                  ...
                  >
                    {!activities
                      ...
                      `NEO ${_toString(activities.collectionName)} #${activities?.tokenId ?? TextPlaceholder
                      }`}
                  </Typography>
                  <Icon
                    style={{ cursor: "pointer" }}
