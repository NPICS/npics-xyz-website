...
const FrameButton = styled.div<{ bg: string, color: string }>`
  /* background: #FF490F; */
            ...
            <AnimateGroup play={isAnimate}>
                <Animate sequenceIndex={1} {...animateProps} delay={0.9}>
                    <div className='frame_info_tool'>
                        <FrameButton bg='#FF490F' color='#fff' onClick={openUrl}>Learn More</FrameButton>
                        <FrameButton bg='#fff' color='#000' onClick={openUrl}>Overview</FrameButton>
                    </div>
                </Animate>
