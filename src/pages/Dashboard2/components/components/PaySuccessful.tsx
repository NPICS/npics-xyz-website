...
export default function PaySuccessful(props:IProps) {
  ...
  >
    <Flex alignItems="center" justifyContent="space-between" marginBottom=".3rem">
      ...
      <div style={{cursor: 'pointer'}}><Icon width=".24rem" height=".24rem" url={imgurl.dashboard.Cancel} onClick={() => {
    ...
    <Flex width="7rem" height="4rem" border="1px solid rgba(0,0,0,.1)" borderRadius="10px" flexDirection='column' justifyContent="space-around">
      <Typography textAlign="center"><Icon width="1.6rem" height="1.6rem" url={imgurl.dashboard.success} /></Typography>
      
      <Flex gap=".2rem" justifyContent="center" alignItems="center">
        <Icon borderRadius="10px" width=".88rem" height=".88rem" url={"https://tva1.sinaimg.cn/large/e6c9d24egy1h3g0c8ugwqj20v50jhgrr.jpg"}/>
        <Flex flexDirection="column">
          ...
          <Flex alignItems="center" gap=".1rem" >
            ...
            <Icon marginLeft=".1rem" width=".14rem" height=".14rem" url={imgurl.dashboard.export14}/>
          </Flex>
        </Flex>
      </Flex>
      ...
      <Flex alignItems="center" justifyContent='center' >
        ...
        <Icon width=".14rem" height=".14rem" url={imgurl.dashboard.export14}/>
      </Flex>
    </Flex>
