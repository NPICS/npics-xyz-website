...
import type { LendPool, LendPoolInterface } from "../LendPool";
...
export class LendPool__factory {
  static readonly abi = _abi;
  static createInterface(): LendPoolInterface {
    return new utils.Interface(_abi) as LendPoolInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): LendPool {
    return new Contract(address, _abi, signerOrProvider) as LendPool;
  }
}
