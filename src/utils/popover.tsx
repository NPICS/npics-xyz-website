...
export function VaultAprPop(props: { rewardAPR: number, interestAPR: number }) {
  ...
  return <Grid width={'6rem'} gridGap=".2rem" borderRadius=".2rem">
    ...
    <Typography fontSize=".14rem" fontWeight="500" color="rgba(0,0,0,.5)">Rates shown are estimates, and fluctuate based
...
export function DownPaymentPop(props: { listedPrice?: BigNumber, loanAmount?: BigNumber }) {
  ...
  return <Grid width={'6rem'} gridGap=".2rem" borderRadius="20px">
    ...
    <Typography fontSize=".14rem" fontWeight="500" color="rgba(0,0,0,.5)">The system obtains the prime price based on
...
export function DebtPop(props: { Principal?: BigNumber, Interest?: BigNumber, noInterest: string }) {
  ...
  return <Grid width={'6rem'} gridGap=".2rem" borderRadius="20px">
    ...
    <Typography fontSize=".14rem" fontWeight="500" color="rgba(0,0,0,.5)">Please note that the interest will be settled
...
export function EstimatProfitPop(props: { purchaseFloorPrice?: BigNumber, ltv?: BigNumber, floorPrice?: BigNumber }) {
  ...
  return <Grid width={'6rem'} gridGap=".2rem" borderRadius="20px">
    ...
    <Typography fontSize=".14rem" fontWeight="500" color="rgba(0,0,0,.5)">The estimated position profit are calculated
