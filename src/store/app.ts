...
const appSlice = createSlice({
    ...
    reducers: {
        ...
        setShowChipSwapAnimate(state, action) {
            state.isShowChipSwapAnimate = action.payload;
        },
